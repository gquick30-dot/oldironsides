        ...
        if (SEAL_TOKEN) {
            try {
                ...
                if (r.ok) {
                    ...
                    console.log("[account-login] Seal raw response:", JSON.stringify(data));
                    let rawList = [];
                    if (Array.isArray(data)) {
                        rawList = data;
                    }
                    else if (Array.isArray(data.payload)) {
                        rawList = data.payload;
                    }
                    else if (Array.isArray(data.subscriptions)) {
                        rawList = data.subscriptions;
                    }
                    ...
                    if (match) {
                        ...
                        const addr = match.shipping_address ||
            ...
            console.warn("[account-login] SEAL_API_TOKEN missing, skipping Seal lookup");
        }

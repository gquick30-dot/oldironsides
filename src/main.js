...
ReactDOM.createRoot(document.getElementById("root")).render(_jsxs(React.StrictMode, { children: [_jsx(PromoSubscribeTrigger, {}), _jsx(App, {})] }));
